...
echo "DEBUG: INPUT_GITHUB_TOKEN=${INPUT_GITHUB_TOKEN:0:10}..."
echo "DEBUG: INPUT_GITHUB_REPOSITORY=$INPUT_GITHUB_REPOSITORY"
echo "DEBUG: GITHUB_REPOSITORY=$GITHUB_REPOSITORY"
GITHUB_TOKEN="${INPUT_GITHUB_TOKEN:-$GITHUB_TOKEN}"
REPO="${INPUT_GITHUB_REPOSITORY:-$GITHUB_REPOSITORY}"
GITHUB_EVENT_PATH="${INPUT_GITHUB_EVENT_PATH:-$GITHUB_EVENT_PATH}"
echo "DEBUG: REPO after assignment=$REPO"
